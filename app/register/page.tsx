...
import { Mail, Lock, User, ArrowRight, Eye, EyeOff, Briefcase, Github } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F0F5FA] flex items-center justify-center p-4 md:p-6 font-sans overflow-y-auto">
      <div className="bg-white rounded-[2.5rem] shadow-xl w-full max-w-5xl overflow-hidden flex flex-col md:flex-row border border-blue-50 my-8 md:my-0">
        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center relative">
          ...
          <div className="max-w-sm w-full mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-1">
                <label className="text-xs font-bold text-slate-600 ml-3">Password</label>
                <div className="relative">
              ...
              <div className="space-y-1">
                <label className="text-xs font-bold text-slate-600 ml-3">Konfirmasi Password</label>
                <div className="relative">
                  <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400" size={20} />
                  <input 
                    type={showPassword ? "text" : "password"} 
              ...
              <div className="space-y-1">
                <label className="text-xs font-bold text-slate-600 ml-3">Daftar Sebagai</label>
                <div className="flex gap-3">
                  <button
                    type="button"
                    onClick={() => setFormData(prev => ({ ...prev, role: 'freelancer' }))}
                    className={`flex-1 py-4 px-4 rounded-2xl font-bold text-sm transition-all ${
